...
def main(args):
    ...
    if "num_train_samples" in config['DATAMODULE']:
        ...
        num_sample_list = [
            int(num / .64) for num in config.getIntList('DATAMODULE', 'num_train_samples')]
    ...
    loss_weights = [10/a_width, 10/b_width]
            ...
            for num_samples in num_sample_list:
                ...
                for run in range(num_runs):
                    ...
                    logger = pl.loggers.TensorBoardLogger(
                        log_dir+f'/num_samples_{num_samples}/img_width_{img_width}/randomized_{randomize}/', name + f"num_samples_{num_samples}")
